...
int HandleUnknownSymbol ( SymbolBlockArr symbolBlockArr , size_t* currentIndex , Position* position , Token* outTokens , size_t* outCount );
int HandleNumberToken ( SymbolBlockArr symbolBlockArr , size_t* currentIndex , Position* position , Token* outTokens , size_t* outCount );
int HandleSeparator ( SymbolBlockArr symbolBlockArr , size_t* currentIndex , Position* position , Token* outTokens , size_t* outCount );
int HandleNewLine ( SymbolBlockArr symbolBlockArr , size_t* currentIndex , Position* position , Token* outTokens , size_t* outCount );